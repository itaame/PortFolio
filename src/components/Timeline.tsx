...
export function TimelineItem({ title, subtitle, meta, badges, children }: TimelineItemProps) {
  return (
    <li className="relative pl-10">
      <span className="absolute left-1 top-1 h-3 w-3 rounded-full border-2 border-white bg-accent shadow-sm dark:border-slate-950" aria-hidden />
      <div className="space-y-3 rounded-2xl border border-slate-200 bg-white p-6 shadow-soft dark:border-slate-800 dark:bg-slate-900">
