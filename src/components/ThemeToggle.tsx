...
type ThemeIconProps = ComponentPropsWithoutRef<'svg'>;

const ThemeLightIcon = (props: ThemeIconProps) => (
  <svg
    viewBox="0 0 24 24"
    fill="none"
    stroke="currentColor"
...
const ThemeDarkIcon = (props: ThemeIconProps) => (
  <svg
    viewBox="0 0 24 24"
    fill="none"
    stroke="currentColor"
...
export default function ThemeToggle({ theme, onChange }: ThemeToggleProps) {
  ...
  const IconComponent = isDark ? ThemeDarkIcon : ThemeLightIcon;
